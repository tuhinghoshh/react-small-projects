...
function Calculator() {
  ...
  const getValue = (e) => {
    ...
    //concat() method creates a new array by appending the value from e.target.value to the existing data array.
  };
  const calculation = () => {
    setData(eval(data).toString());
    //eval() method in JavaScript is used to evaluate or execute a string as JavaScript code.
  };
  const back = () => {
